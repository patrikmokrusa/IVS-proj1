...
public:
     ...
     * @brief listu sousedu 
     * 
     * @return pointer na vector sousedu, kdyz se nepovede malloc tak vraci nullptr
     * 
     * Index v listu se rovna NodeId.
     * adj_list[NodeId]  je vektor sousedu uzlu s NodeId.
    */
    std::vector<size_t>* create_adj_list();

    /**
     * @brief destruktor listu sousedu
    */
    void adj_list_dtor(std::vector<size_t>* ptr);
